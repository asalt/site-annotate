...
data_dir <- "/media/alex/Expansion/MSPC001141/data/processed/acetyl/fragpipe/"
...
possible_id_cols <- c("ENSG", "ENST", "ENSP", "geneid", "symbol", "taxon", "fifteenmer", "position", "AA", "sitename", "protein_length")
...
.res <- datas_reduced_withisoind[[1]] %>%
  group_by(fifteenmer,
           geneid,
           ENSG,
           # position
